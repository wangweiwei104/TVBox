...
public class LivePlayerManager {
    ...
    public void init(VideoView videoView) {
        try {
//            defaultPlayerConfig.put("pl", Hawk.get(HawkConfig.LIVE_PLAYER_TYPE, Hawk.get(HawkConfig.PLAY_TYPE, 0)));
            int playerType = Hawk.get(HawkConfig.LIVE_PLAYER_TYPE, -1);
//            int p2 = Hawk.get(HawkConfig.LIVE_PLAYER_TYPE, Hawk.get(HawkConfig.PLAY_TYPE, 0));
